...
import ddify from "../../assets/dify.png";
import fflowise from "../../assets/flowise.png";
import Lopenai from "../../assets/openai.png";
                ...
                <TableRow key={integration.id}>
                  <TableCell >
                    ...
                    {integration.type === "typebot" && (<Avatar
                      ...
                      {integration.type === "dify" && (<Avatar
                      src={ddify} className={classes.avatar} />)}
                      {integration.type === "flowise" && (<Avatar
                      src={fflowise} className={classes.avatar} />)}
                      {integration.type === "openaiassist" && (<Avatar
                      src={Lopenai} className={classes.avatar} />)}
                  </TableCell>
