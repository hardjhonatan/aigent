...
const QueueIntegration = ({ open, onClose, integrationId }) => {
  ...
  const handleSaveDialogflow = async (values) => {
    try {
      if (values.type === 'n8n' || values.type === 'webhook' || values.type === 'typebot' || values.type === "flowise" || values.type === "openaiassist" || values.type === "dify") values.projectName = values.name
      if (integrationId) {
              ...
              <Paper square className={classes.mainPaper} elevation={1}>
                <DialogContent dividers>
                  <Grid container spacing={1}>
                    <Grid item xs={12} md={6} xl={6}>
                      ...
                      >
                        ...
                        >
                          ...
                          <MenuItem value="openaiassist">openaiassist</MenuItem>
                    ...
                    {(values.type === "n8n" || values.type === "webhook" || values.type === "flowise" || values.type === "dify") && (
                      <>
                        <Grid item xs={12} md={6} xl={6} >
                          <Field
                            as={TextField}
